...
13. The receiver does require a formatted LittleFS file system on the ESP32 flash. It will auto format during the 1st run. 
If the SD card option does not work, you can use the LittleFS uploader (https://github.com/earlephilhower/arduino-littlefs-upload) to upload the files to LittleFS.
