   ...
   tft.setTextSize(1);    
    ...
    switch (i / 25) {
     ...
     if (ySh < 50) {
      ...
      if (modType != WBFM)
      switch (i / 25) {
        case -2: tft.drawCentreString("-50", x0 + 11, y0 - 6, 1); break;
        case -1: tft.drawCentreString("-25", x0 + 2, y0, 1); break;
        case 0: tft.drawCentreString("0", x0, y0 + 5, 1); break;
        case 1: tft.drawCentreString("25", x0, y0, 1); break;
        case 2: tft.drawCentreString("50", x0 - 8, y0 - 6, 1); break;
      }
...
if(!showMeters || scanMode)
  ...
  //tft.drawRightString(buf, 33 + xSh, M_SIZE*(119 - 20), 2);
