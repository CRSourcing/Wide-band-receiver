...
It uses single conversion for frequencies below 50MHz and double conversion above. A crystal filter before the SI4732 and a SI5351 as local oscillator improve filtering and eliminate the chuffing noise 
of a SI4732 only receiver.
