...
It uses single conversion for frequencies below 50MHz and double conversion above. A crystal filter in front of the SI4732 and a SI5351 as local oscillator improve filtering and eliminate chuffing noises. 

A NOS I2C tv tuner covers 50-860MHz. A "shortwave only" version (without tuner) can be compiled.
...
These tuners are currently available on the internet from several sources. Tuner AGC voltage gets generated by one of the ESP32 DAC's.   
...
It does include some nice features, such as morse decoder, slow scan waterfall, memory bank scanning, station lists, .wav recorder, WIFI file transfer, etc.
...
See the main file SI4732Radio_V0_572.ino for more details.
![Alt text](pics/1.jpg)
