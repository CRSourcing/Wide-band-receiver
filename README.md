...
A tinySA can be added and will then get synchronized by the receiver via serial connection.      
...
Other Philips I2C tuners may have a different pinout and different IF and AGC specs, but should work as long as they use the same data format (4 byte Philips telegram).
...
See the main file SI4732Radio_V0_525.ino for more details.
![Alt text](pics/1.jpg)
